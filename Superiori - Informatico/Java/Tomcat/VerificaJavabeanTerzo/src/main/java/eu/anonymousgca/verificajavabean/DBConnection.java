...
public class DBConnection {
    ...
    private static final String DB_CONNECTION = "jdbc:mysql://172.22.201.51:3306/TPS_STAZIONE";
     ...
     * */
    public boolean autenticazione(String stazione, String pin){
        ResultSet rs = null;
        try {
            Statement stmt = dbConnection.createStatement();
            String select = "SELECT * FROM stazioni WHERE nomeStazione='" + stazione + "' AND pin='" + pin + "';";
            rs = stmt.executeQuery(select);
        } catch (SQLException e) {
            System.out.println("Errore esecuzione query (dati inseriti: " + stazione + " e " + pin);
            return false;
        }
        ...
        try {
            if (rs.next()){
                ...
                System.out.println("Stazione trovata con nome: " + stazione + " e pin: " + pin);
                return true;
            }
