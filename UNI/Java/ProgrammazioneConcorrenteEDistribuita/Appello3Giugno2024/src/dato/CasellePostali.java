...
public class CasellePostali {
	...
	private Hashtable<String, Messaggio> messaggi;	// NB: per ogni utente è previsto un solo messaggio. Per essere realistici ci vorrebbe una lista di messaggi.
	...
	// inserisce un messaggio (sovrascrivendo il messaggio eventualmente già presente per il destinatario
