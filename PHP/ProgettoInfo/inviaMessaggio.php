                ...
                <div class="row text-center">
                    <div class="col">
                        <div>
                            ...
                            <input type="color" class="form-control form-control-color bg-light bg-opacity-10 border border-dark w-100" id="color" name="colore" value="#000000" title="Personalizza colore bordo">
                        </div>
                    </div>
                </div>
