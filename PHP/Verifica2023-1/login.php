...
<head>
    <meta charset="UTF-8">
    <title>Verifica - Login - GCA</title>
...
<div class="container mt-5">
    <!-- Form di login con email e password e post a login.php -->
    <form class="border border-dark rounded-3 p-3 action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="mb-3">
